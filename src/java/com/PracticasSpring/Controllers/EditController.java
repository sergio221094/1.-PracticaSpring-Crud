...
public class EditController 
{
    ...
    public ModelAndView form(HttpServletRequest request)
    {
        ...
        mav.addObject("usuarios",new Usuarios(id,datos.getNombre(),datos.getIdentificacion(),datos.getCorreo(),datos.getTelefono()));
        return mav;
    }
        ...
        )
    {
        ...
        this.jdbcTemplate.update(
                ...
                + "where "
                + "id=? ",
         u.getNombre(),u.getIdentificacion(),u.getCorreo(),u.getTelefono(),id);
